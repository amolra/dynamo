...
const module_creation_2 = require("./react-setup/module-creation");
const template_creation_1 = require("./node-setup/template-creation");
const template_creation_2 = require("./react-setup/template-creation");
    ...
    yield (0, index_1.createprojectStructure)(fetTech).subscribe((result) => __awaiter(void 0, void 0, void 0, function* () {
        if (result) {
            ...
            if (fetTech === 'Angular') {
                ...
                //Code from Dynamo
                const responseGenerateCode = yield (0, module_creation_2.createEntireReactCode)(fetTech, template, req.body.component);
...
app.post('/api-template-generation', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log('req.body', req.body);
    if (req.body.htmlContent && req.body.cssContent) {
        const responseSetApi = yield (0, template_creation_1.createTemplate)(req.body.htmlContent, req.body.cssContent, req.body.templateDirectoryName);
...
app.post('/react-template-generate', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log('req.body', req.body);
    if (req.body.htmlContent && req.body.cssContent) {
        const responseSetApi = yield (0, template_creation_2.createTemplateForReact)(req.body.htmlContent, req.body.cssContent);
        responseSetApi.subscribe((eleModCreate) => {
            if (res.headersSent !== true) {
                return res
                    .contentType('application/json')
