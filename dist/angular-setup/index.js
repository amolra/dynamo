...
exports.createprojectStructure = exports.changeDir = exports.install = exports.createFolders = void 0;
...
function createFolders() {
    ...
    let fs = require('fs');
    let childDirectories = [constants_1.dir + '/' + constants_1.angularDir, constants_1.dir + '/nodejs-code'];
    let i = 0;
...
function install() {
    const subToReturn = new rxjs_1.BehaviorSubject(false);
    (0, shelljs_1.exec)(constants_1.basePath + constants_1.projectFolder + '/angular-setup/install.sh', (error, stdout, stderr) => {
        if (error) {
